...
<body>
	...
	<div class="aui-content-box">
		<div class="aui-banner-content aui-fixed-top" data-aui-slider>
			<div class="aui-banner-wrapper">
				<div class="aui-banner-wrapper-item">
					<a href="#">
						<img src="/Public/Home/img/banner/banner.jpg">
					</a>
				</div>
				<div class="aui-banner-wrapper-item">
					<a href="#">
						<img src="/Public/Home/img/banner/banner1.jpg">
					</a>
				</div>
				<div class="aui-banner-wrapper-item">
					<a href="#">
						<img src="/Public/Home/img/banner/banner2.jpg">
					</a>
				</div>
				<div class="aui-banner-wrapper-item">
					<a href="#">
						<img src="/Public/Home/img/banner/banner3.jpg">
					</a>
				</div>
			</div>
		...
		<section class="aui-grid-content">
			<div class="aui-grid-row">
				<a href="<?php echo U('MySign/index');?>" class="aui-grid-row-item">
					<i class="aui-icon-large aui-icon-sign"></i>
					<p class="aui-grid-row-label">每日签到</p>
				</a>
				<a href="<?php echo U('MyTime/index');?>" class="aui-grid-row-item">
					<i class="aui-icon-large aui-icon-time"></i>
					<p class="aui-grid-row-label">限时抢购</p>
				</a>
				<a href="<?php echo U('MyMembership/index');?>" class="aui-grid-row-item">
					<i class="aui-icon-large aui-icon-vip"></i>
					<p class="aui-grid-row-label">会员专享</p>
				</a>
				<a href="<?php echo U('MyPurchase/index');?>" class="aui-grid-row-item">
					<i class="aui-icon-large aui-icon-group"></i>
					<p class="aui-grid-row-label">好货拼团</p>
				</a>
				<a href="<?php echo U('MyInvitation/index');?>" class="aui-grid-row-item">
		...
		<div class="aui-list-content">
						...
						<ul class="aui-slide-item-list">
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/pd-zf-5.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-9.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-10.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-11.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-12.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-13.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-14.jpg">
			...
			<div class="aui-list-item">
				<div class="aui-list-item-img">
					<img src="/Public/Home/img/pd/cf-5.jpg" alt="">
				</div>
				<div class="aui-slide-box">
					<div class="aui-slide-list">
						<ul class="aui-slide-item-list">
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-15.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-16.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-17.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="#" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-18.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-19.jpg">
			...
			<div class="aui-list-item">
				<div class="aui-list-item-img">
					<img src="/Public/Home/img/pd/cf-7.jpg" alt="">
				</div>
				<div class="aui-slide-box">
					<div class="aui-slide-list">
						<ul class="aui-slide-item-list">
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-25.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-26.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-27.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-28.jpg">
									<p class="aui-slide-item-title aui-slide-item-f-els">唯他可可 椰子水饮料 330毫升/盒 12盒</p>
									<p class="aui-slide-item-info">
										<span class="aui-slide-item-price">¥189</span>&nbsp;&nbsp;<span class="aui-slide-item-mrk">¥299</span>
									</p>
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-29.jpg">
									<p class="aui-slide-item-title aui-slide-item-f-els">巴黎水 含气青柠味饮料 330毫升 24</p>
									<p class="aui-slide-item-info">
										<span class="aui-slide-item-price">¥129</span>&nbsp;&nbsp;<span class="aui-slide-item-mrk">¥199</span>
									</p>
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-30.jpg">
									<p class="aui-slide-item-title aui-slide-item-f-els">calbee 卡乐比 日本进口休闲零食佳可比黄油味薯条 90克/盒</p>
									<p class="aui-slide-item-info">
										<span class="aui-slide-item-price">¥19.9</span>&nbsp;&nbsp;<span class="aui-slide-item-mrk">¥49</span>
									</p>
			...
			<div class="aui-list-item">
				<div class="aui-list-item-img">
					<img src="/Public/Home/img/pd/cf-6.jpg" alt="">
				</div>
				<div class="aui-slide-box">
					<div class="aui-slide-list">
						<ul class="aui-slide-item-list">
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-20.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-21.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-22.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-23.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/Public/Home/img/pd/sf-24.jpg">
    ...
    <a href="<?php echo U('My/index');?>" class="aui-footer-item">
