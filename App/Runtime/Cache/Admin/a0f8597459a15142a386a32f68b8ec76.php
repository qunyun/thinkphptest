			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" pc>
						...
						<dl class="layui-nav-child">
							<dd><a href="javascript:;" data-url="<?php echo U('User/userInfo');?>"><i class="iconfont icon-zhanghu" data-icon="icon-zhanghu"></i><cite>个人资料</cite></a></dd>
							<dd><a href="javascript:;" data-url="<?php echo U('User/changePwd');?>"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>修改密码</cite></a></dd>
