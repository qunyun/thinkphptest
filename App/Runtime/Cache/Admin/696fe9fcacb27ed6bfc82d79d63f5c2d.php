...
<body class="childrenBody">
	<div class="panel_box row">
		<div class="panel col">
			<a href="javascript:;" data-url="<?php echo U('message');?>">
		...
		<div class="panel col">
			<a href="javascript:;" data-url="<?php echo U('allUsers');?>">
		...
		<div class="panel col">
			<a href="javascript:;" data-url="<?php echo U('images');?>">
		...
		<div class="panel col">
			<a href="javascript:;" data-url="<?php echo U('newsList');?>">
