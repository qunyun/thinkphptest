...
<head>
	...
	<link rel="icon" href="/Public/Admin/favicon.ico">
...
<body class="main_body">
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main">
			    ...
			    <ul class="layui-nav top_menu">
			    	...
			    	<li class="layui-nav-item" mobile>
			    		<a href="javascript:;" data-url="<?php echo U('changePwd');?>"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>设置</cite></a>
			    	</li>
			    	<li class="layui-nav-item" mobile>
					...
					<li class="layui-nav-item" pc>
						<a href="javascript:;">
							<img src="/Public/Admin/images/face.jpg" class="layui-circle" width="35" height="35">
							<cite>请叫我马哥</cite>
						</a>
						<dl class="layui-nav-child">
							<dd><a href="javascript:;" data-url="<?php echo U('userInfo');?>"><i class="iconfont icon-zhanghu" data-icon="icon-zhanghu"></i><cite>个人资料</cite></a></dd>
							<dd><a href="javascript:;" data-url="<?php echo U('changePwd');?>"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>修改密码</cite></a></dd>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="/Public/Admin/images/face.jpg"></a>
			...
			<div class="layui-tab marg0" lay-filter="bodyTab">
				...
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						<iframe src="<?php echo U('main');?>"></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="layui-footer footer">
			<p>商城@<a href="http://www.php.cn" target="_blank">后台页面</a></p>
		</div>
	</div>
	...
	<script type="text/javascript" src="/Public/Admin/js/nav.js"></script>
